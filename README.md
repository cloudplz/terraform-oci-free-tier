...
| <a name="input_https_ingress_cidr"></a> [https\_ingress\_cidr](#input\_https\_ingress\_cidr) | Optional CIDR allowed to access HTTPS (TCP 443) on the compute fleet. Set null to create no HTTPS ingress rule. | `string` | `null` | no |
